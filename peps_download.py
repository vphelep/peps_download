...
if len(sys.argv) == 1:
    ...
    parser.add_option("-d", "--start_date", dest="start_date", action="store", type="string",
                      help="start date, fmt('2015-12-22')", default=(datetime.datetime.now() - datetime.timedelta(days=9)).date().strftime('%Y-%m-%d'))
    ...
    parser.add_option("-f", "--end_date", dest="end_date", action="store", type="string",
                      help="end date, fmt('2015-12-23')", default=(datetime.datetime.now() - datetime.timedelta(days=2)).date().strftime('%Y-%m-%d'))
